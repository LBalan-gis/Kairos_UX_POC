...
// Pure presentation component — no store imports.
// Live tag resolution happens in WidgetRenderer before this component mounts;
// it receives an already-resolved `value` as a plain number prop.
//
// lowerIsBetter: set true for metrics where low = bad (OEE, yield, throughput).
//   When true, warnAt/critAt are LOWER bounds — value below critAt = red, below warnAt = amber.
//   Default false = high is bad (temperature, pressure, error rate).
export function WidgetGauge({
  ...
  // Threshold coloring — direction-aware
  let color, dropShadow;
  ...
  return (
    <div style={{ padding: 20, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <div style={{
        ...
        color: labelColor, marginBottom: 16, textTransform: 'uppercase',
        ...
        {live && (
          <span style={{
            ...
            color: dark ? 'rgba(42,241,229,0.90)' : '#0284C7',
      ...
      <div style={{ position: 'relative', width: 90, height: 90, filter: dropShadow }}>
        <svg width="90" height="90" viewBox="0 0 90 90">
          <circle
            ...
            fill="none" stroke={trackColor} strokeWidth="6"
          />
          <circle
            cx="45" cy="45" r={radius}
        ...
        <div style={{
          ...
          <span style={{ fontSize: 9, color: unitColor, marginTop: -2 }}>
            {unit}
          </span>
        </div>
      </div>
