...
/**
 * @param {object} payload        — widget JSON payload
 * @param {function} liveDataProvider — (tag: string) => number | undefined
 * @param {string[]} liveTagIds   — registered namespace tags (from store.liveIds)
 */
export function gateWidget(payload, liveDataProvider, liveTagIds) {
